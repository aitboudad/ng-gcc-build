...
var NgbModalStack = (function () {
    ...
    NgbModalStack.prototype._getContentRef = function (moduleCFR, contentInjector, content, context) {
        if (!content) {
            ...
            var /** @type {?} */ modalContentInjector = ReflectiveInjector.resolveAndCreate([{ provide: NgbActiveModal, useValue: context }], contentInjector);
...
var NgbTypeahead = (function () {
    ...
    NgbTypeahead.prototype.ngOnInit = function () {
        var _this = this;
        var /** @type {?} */ inputValues$ = _do.call(this._valueChanges, function (value) {
            _this._userInput = value;
            if (_this.editable) {
                _this._onChange(value);
            }
        });
        var /** @type {?} */ results$ = letProto.call(inputValues$, this.ngbTypeahead);
        var /** @type {?} */ userInput$ = _do.call(results$, function () {
            if (!_this.editable) {
...
//# sourceMappingURL=ng-bootstrap.es5.js.map
